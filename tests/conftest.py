...
def test_data():
    return SimpleNamespace(
        ...
        FACEBOOK_SHARER_URL="https://www.facebook.com/sharer.php?u=",
        TWITTER_SHARER_URL="https://twitter.com/intent/tweet/?",
        EMAIL_SHARER_URL=(
            "mailto:?subject=Check this ConsumerAffairs News&body=Check out this news: "
        ),
...
# TODO: Test Data: SimpleNamespace - comment( está simples mas poderia reaproveitar em outros cenários)
